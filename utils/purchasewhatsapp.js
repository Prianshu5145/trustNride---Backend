 ...
 */
async function purchasetokenwhatsapp(phoneNumberId, messagingProduct,file,ownerName,
    ownerWhatsApp,
    carTitle,
...
const bodytemplatemessage2customer  =    {
        ...
        type: "template",
        template: {
          name: "carpurchasetokencustomermessage",
          language: {
            code: "en_US"
          },
          components: [
...
module.exports = {purchasetokenwhatsapp};
